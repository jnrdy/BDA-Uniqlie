...
proc casutil;
  Load casdata="Forest___Close_1.sashdat" incaslib="Models" casout="Forest___Close_1" outcaslib="casuser" replace;
Quit;
...
proc cas;
  ...
  routineCode = "
   ...
   Generated SAS Scoring Code
     ...
     ------------------------------------------*/
declare object Forest___Close_1(astore);
call Forest___Close_1.score('CASUSER','Forest___Close_1');
   /*------------------------------------------*/
   /*_VA_DROP*/ drop 'P_Close'n;
      'P_Close_4619'n='P_Close'n;
   /*------------------------------------------*/
";
